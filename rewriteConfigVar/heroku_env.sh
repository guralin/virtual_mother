...
heroku config:set ACCESS_TOKEN_SECRET="$access_token_secret" --app virtualmother-develop
heroku config:set ACCESS_TOKEN_SECRET="$access_token_secret" --app virtualmother
